...
class ConnectionFactory extends \Illuminate\Database\Connectors\ConnectionFactory
{
     ...
     * @return \CloverSwoole\Database\Connection
     */
     ...
     *
     * @param  array  $config
     * @return \CloverSwoole\Database\Connectors\ConnectorInterface
     *
    ...
    protected function createConnection($driver, $connection, $database, $prefix = '', array $config = [])
    {
        ...
        switch ($driver) {
            case 'mysql':
                return new \CloverSwoole\Database\MySqlConnection($connection, $database, $prefix, $config);
        }
